...
var remoteCmd = &cobra.Command{
	Use:   "remote",
	Short: "Add and remove prefixes to the specified GoBGPd instance while keep dumping the global RIB",
	Long:  `This command lanuches goroutines to concurrently add, remove and dump prefixes.`,
